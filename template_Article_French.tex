...
\begin{document}
	...
	\section{Les behavior tree en robotique}
		...
		Les robots sont de plus en plus utilisés dans le domaine militaire. Aujourd’hui on peut plus facilement créer des robots discrets et dotés de nombreux capteurs, ce qui est idéal pour des missions d’espionnage ou d’éclairement.
