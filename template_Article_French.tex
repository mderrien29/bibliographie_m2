...
\begin{document}
	...
	\section{Les outils implémentant les behavior trees}
		\subsection{outils utilisés}
			...
			La bibliothèque est accessible au public sur \cite{ros.org} et le référentiel de développeur est disponible sur \cite{miccol_2018_dev}. Une version non ROS de la bibliothèque en C ++ est disponible à l'adresse \cite{miccol_2018}. La bibliothèque est actuellement l’implémentation de ROS BT la plus étoilée disponible dans GitHub.
			\\
